...
const TestimonialSingle = ({ item }) => {
  ...
  return (
    <Card>
      <blockquote
        className={`bg-base-200 text-base-content mx-auto mb-2 w-full rounded-lg border p-3 font-light  shadow-lg transition hover:shadow-2xl
    ${
      readMore
        ? " border-accent absolute col-span-3 shadow-2xl"
        : "border-base-300"
    } `}
      >
        <div className="mb-4 flex w-full items-center">
          ...
          <div className="name-holder">
            <h6 className="text-sm font-bold uppercase ">{item.name}</h6>
          </div>
        </div>
...
const Testimonial = () => {
  return (
    <section className="bg-color-1 no-clip ">
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="mx-auto max-w-xl text-center">
            ...
            <div className="mb-4 text-center">
              <span className="bg-accent ml-1 inline-block h-1 w-1 rounded-full"></span>
              <span className="bg-accent ml-1 inline-block h-1 w-3 rounded-full"></span>
              <span className="bg-accent inline-block h-1 w-40 rounded-full"></span>
              <span className="bg-accent ml-1 inline-block h-1 w-3 rounded-full"></span>
              <span className="bg-accent ml-1 inline-block h-1 w-1 rounded-full"></span>
            </div>
          </div>
